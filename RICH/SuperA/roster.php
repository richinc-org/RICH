  ...
  <div class="site-wrap">
    ...
    <div style="padding-bottom: 350px;" class="text-center">
      ...
      ?>
        ...
        ?>
                              ...
                              DOB: <input type="text" name="newdob" value="<?php echo htmlspecialchars($row['DOB'])?>"><br>
                              Email Address: <input type="text" name="newea" value="<?php echo htmlspecialchars($row['EmailAddress'])?>"><br>
                              School: <input type="text" name="newsch" value="<?php echo $schoolName?>"><br>
        <?php
                            }
                          }
                        }
        ...
        <?php
              ...
              if (htmlspecialchars(($_GET['a']) == 'abl')) {
                ...
                $sqlcom = "UPDATE Students SET Status = 'active' WHERE Uid = '$studentID';";
                $db->save($sqlcom);
            ?>
            ...
            <?php
              ...
              if (htmlspecialchars(($_GET['a']) == 'dis')) {
                ...
                $sqlcom = "UPDATE Students SET Status = 'disabled' WHERE Uid = '$studentID';";
                $db->save($sqlcom);
            ?>
                <script type="text/javascript">
                  window.location.href = "roster.php";
    ...
    <?php
              ...
              if (isset($_POST['filter'])) {
                ...
                if ($school == "all") {
                  $sqlthree = "SELECT * FROM Students";
                }
                else{
                  $sqlthree = "SELECT * FROM Students WHERE SchoolUid = '$school';";
                }
              }
              else{
                $sqlthree = "SELECT * FROM Students";
              ...
              if ($resulthree) {
                ...
                if ($qDthree > 0){
                  ...
                  if (isset($_POST['filter'])) {
                    $school = addslashes($_POST['schools']);
                    if ($school == "all") {
                      $sqlfor = "SELECT * FROM Students LIMIT " . $first_result . "," . $resultsperpage;
                    }
                    else{
                      $sqlfor = "SELECT * FROM Students WHERE SchoolUid = '$school' LIMIT " . $first_result . "," . $resultsperpage;
                    }
                  }
                  else{
                    $sqlfor = "SELECT * FROM Students LIMIT " . $first_result . "," . $resultsperpage;
    ...
    <?php                 
        ...
        ?> 
                            ...
                            <td name = 'ca'>
                              ...
                              ?>
                                  <a href="roster.php?a=abl&id=<?php echo htmlspecialchars($rowC['Uid']); ?>">
                              ...
                              ?>
                                  <a href="roster.php?a=dis&id=<?php echo htmlspecialchars($rowC['Uid']); ?>">
