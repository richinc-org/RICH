...
<body>
  ...
  <div class="site-wrap">
    ...
    <div style="padding-bottom: 100px;" class="text-center">
        ...
        <div class = "col-md-12 mx-auto no-sidebar" >
          <div id = "assignmentContainer" class="shapely-content">
            <form action = "../php/dailywritings.php" method = "POST">
              ...
              ?>">
              <h3>Title:</h3>
              <textarea id = "titleEssay" name = "artTitle" spellcheck="true" style = "width: 100%; border: 1px solid #8585859c; text-align: left;" rows = "1" required><?php
                $DB = new Database;
                $conn = $DB->connect();
              ...
              ?></textarea>
              <h4>Weekly Writing:</h4>

              <div id="WeeklyWriting">

                <textarea id = "editor" name = "articletext" spellcheck="true" style = "height: 500px; width: 100%;" required><?php
                $DB = new Database;
                $conn = $DB->connect();
                if (isset($_GET)) {
                  if (isset($_GET['edit'])) {
              ...
              ?></textarea><br>
                ...
                <textarea id = "principlesUsed" name = "principle" spellcheck="true" style = "width: 100%; border: 1px solid #8585859c;" rows = "3" required><?php
                $DB = new Database;
                $conn = $DB->connect();
                if (isset($_GET)) {
                  if (isset($_GET['edit'])) {
            ...
            <br><br>
            <section style="height: auto; margin-bottom: 200px;">
      ...
      ?>
                          <div class = 'articlesFetch'>
                            ...
                            <a href="weekly-writings.php?edit=e&id=<?php echo htmlspecialchars($row['ArticleID']); ?>&u=<?php echo htmlspecialchars($row['Student']); ?>"><button>Edit</button></a>
                            <a href="weekly-writings.php?action=d&id=<?php echo htmlspecialchars($row['ArticleID']); ?>&u=<?php echo htmlspecialchars($row['Student']); ?>"><button>Delete</button></a>
                          </div>
      <?php
                        }
                      }
    ...
    ?>
      ...
      ?>
                          <div class = 'articlesFetch'>
                            <a href="mywritings.php?view=v&id=<?php echo htmlspecialchars($row['ArticleID']);?>&u=<?php echo htmlspecialchars($row['Student']);?>"><?php echo htmlspecialchars($row['Title']); ?></a><br>
                            Created: <?php echo $row['DateAdded']; ?><br>
